...
export const projects: Project[] = [
    {
        ...
        thumbnailAlt: "egenus web app landing page with service sidebar and map with location markers",
        links: [
            {
    ...
    },
    {
        ...
        thumbnailAlt: "Rootrack landing page with dark theme, animated graph and 'Track Your Betting Journey' title",
        links: [
            {
    ...
    },
    {
        ...
        thumbnailAlt: "Blattwerk e.V. website with painting-styled background and animated cannabis plants",
        links: [
            {
    ...
    },
    {
        ...
        thumbnailAlt: "DB Fahrtrichtung Firefox addon showing Deutsche Bahn website with carriage routing link",
        links: [
            {
    ...
    },
    {
        ...
        thumbnailAlt: "Andrea Gotti portfolio website with clean, minimalistic white design",
        links: [
            {
