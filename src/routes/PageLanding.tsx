...
export function PageLanding() {
    ...
    return (
        <div className="w-full min-h-dvh bg-slate-100 px-8 md:px-[10%] xl:px-[25%] 2xl:px-[30%] py-24 relative">
            <DockComponent />
            ...
            >
                <h1 className="text-4xl md:text-6xl font-bold text-slate-900 flex gap-4">
                ...
                <p className="text-md md:text-xl text-slate-800 mt-4">
            ...
            >
                ...
                <div className="flex w-full gap-1 flex-wrap">
                    {skills.map((skill, index) => (
                        <SkillChip key={index + skill} title={skill} />
                    ))}
                </div>
            </motion.div>
            ...
            <motion.div
                ...
                viewport={{ once: true }}
            >
                <h2 className="text-4xl font-bold text-slate-900 text-center mb-1">My favorite projects</h2>
                <p className="text-xl text-slate-600 text-center">Here are the projects that I am proud of and that I particularly enjoyed developing.</p>
            </motion.div>
            <Spacer y={8} />
            ...
            >
                <h2 className="text-4xl font-bold text-slate-900 text-center mb-1">Contact</h2>
                <p className="text-xl text-slate-600 text-center">
                    Would you like to talk to me? Just <a href="mailto:deniz.petzold@gmail.com" target="_blank" className="text-blue-400">send me an email</a> or <a href="https://www.linkedin.com/in/dpetzold/" target="_blank" className="text-blue-400">contact me on LinkedIn</a> and I will get back to you as soon as possible.
                </p>
            </motion.div>
